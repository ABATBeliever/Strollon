...
class ThemeEngine:
    ...
    def _ensure_builtin_themes(self):
        ...
        または INI の strollon_version が現在のブラウザバージョンと一致しない場合に
        ...
        _BUILTIN_NAMES = {
            ...
            "Soda":    _BUILTIN_SODA_INI,
            "Gamer":   _BUILTIN_GAMER_INI,
        }
    ...
    def _write_builtin_if_outdated(self, name: str, content: str):
        """
        ファイルが存在しない、または strollon_version が現バージョンと異なる場合に書き出す。
        """
        from constants import BROWSER_VERSION_SEMANTIC
        path = self.themes_dir / f"{name}.ini"
        if path.exists():
            stored_ver = self._get_ini_strollon_version(path)
        ...
        try:
            ...
            print(f"[INFO] Theme: wrote built-in '{name}.ini' (strollon_version={BROWSER_VERSION_SEMANTIC})")
        except OSError as e:
...
; ============================================================
; Strollon Browser - Default (Light) テーマ
; ============================================================
; このファイルは Strollon の組み込みデフォルトテーマです。
...
name        = Default
author      = ABATBeliever
description = Strollonブラウザ標準ライトテーマ
version     = 1.0
strollon_version = {BROWSER_VERSION_SEMANTIC}
...
_BUILTIN_DARK_INI = """\
; ============================================================
; Strollon Browser - Dark テーマ
; ============================================================

[info]
name        = Dark
author      = ABATBeliever
description = Strollonブラウザ標準ダークテーマ
version     = 1.0
strollon_version = {BROWSER_VERSION_SEMANTIC}
...
_BUILTIN_SODA_INI = """\
; ============================================================
; Strollon Browser - Soda テーマ
; ============================================================

[info]
name        = Soda
author      = ABATBeliever
description = 爽やかな水色・シアン基調のライトテーマ
version     = 1.0
strollon_version = {BROWSER_VERSION_SEMANTIC}
...
bg_window           = #f2fbfd
bg_surface          = #ffffff
bg_surface_dim      = #edf8fc
bg_surface_alt      = #e8f6fb
bg_sidebar          = #dff3f9
bg_toolbar          = #ccedf7
bg_hover            = #d8f0f8
border_default      = #9dd8ec
border_light        = #b8e4f2
border_grid         = #8ecfe6
text_primary        = #0d2f3a
text_secondary      = #3a6878
text_muted          = #5a8090
text_disabled       = #9abcc8
text_placeholder    = #90b8c4
accent_primary      = #0097b2
accent_hover        = #0086a0
accent_pressed      = #006e88
accent_dark         = #005570
accent_light        = #d6f0f8
accent_lighter      = #bce8f4
accent_win          = #0097b2
accent_win_hover    = #0086a0
accent_incognito    = #7060d0
color_warning       = #c05030
color_danger        = #d03030
color_success       = #207850
color_bookmark      = #e8a020
tooltip_bg          = #0d2f3a
tooltip_text        = #ffffff
tooltip_border      = #005570
"""

_BUILTIN_GAMER_INI = """\
; ============================================================
; Strollon Browser - Gamer テーマ
; ============================================================

[info]
name        = Gamer
author      = ABATBeliever
description = 薄紫・ダーク基調のゲーミングテーマ
version     = 1.0
strollon_version = {BROWSER_VERSION_SEMANTIC}
...
bg_window           = #12101a
bg_surface          = #1c1828
bg_surface_dim      = #171422
bg_surface_alt      = #221e30
bg_sidebar          = #171422
bg_toolbar          = #201c2e
bg_hover            = #2a2440
border_default      = #3a3258
border_light        = #4a4068
border_grid         = #322c4e
text_primary        = #e0d8f8
text_secondary      = #a098c8
text_muted          = #8878a8
text_disabled       = #504868
text_placeholder    = #584e70
accent_primary      = #a060f0
accent_hover        = #9050e0
accent_pressed      = #7838c8
accent_dark         = #c898ff
accent_light        = #2a1e48
accent_lighter      = #20163c
accent_win          = #a060f0
accent_win_hover    = #9050e0
accent_incognito    = #e060a0
color_warning       = #e06040
color_danger        = #e04060
color_success       = #40c080
color_bookmark      = #f0c030
tooltip_bg          = #0c0a14
tooltip_text        = #e0d8f8
tooltip_border      = #5a4888
"""
...
# グローバルシングルトン
# =====================================================================
# StrollonBrowser.py で初期化し、他モジュールは
