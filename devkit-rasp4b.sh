...
echo "============================================"
echo " Strollon Development Kit for RaspberryPi 4B"
echo "============================================"
echo
...
if command -v apt-get >/dev/null 2>&1; then
    sudo apt-get install -y binutils patchelf gcc build-essential rpm libminizip1t64 libsnappy1v5 python3-dev
